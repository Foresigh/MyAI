...
export const PLAN_DEFINITIONS: Record<PlanId, PlanDefinition> = {
  free: {
    ...
    tagline: "Everything you need to try Arvo locally.",
    model: "qwen3:8b",
    dailyMessageLimit: 40,
    contextWindow: "~8K tokens of history",
    features: [
      { label: "Arvo 1.0 access", included: true },
  ...
  hobby: {
    ...
    features: [
      { label: "Extended Arvo 1.0 capacity", included: true },
  ...
  pro: {
    ...
    contextWindow: "Full model context window",
    features: [
      { label: "Expanded Arvo 1.0 capacity", included: true },
  ...
  max: {
    ...
    contextWindow: "Full model context window",
    features: [
      { label: "Maximum Arvo 1.0 capacity", included: true },
  ...
  premium: {
    ...
    price: "$100",
    priceDetail: "/ month",
    bestFor: "Small teams or families sharing one Arvo instance.",
